...
#		print "ident: $ident name: $name value: $value\n";
   ...
   sub writeRec {
	my (
	$id,$jmeno,$prijmeni,$pohlavi,$datnar,$zps,$id_zs,$id_ss,$ulice,$misto,$psc,	$id_studium,$p1,$p2,$p3,$prumer,$body,$vstup,$cj,$m,$jazyk,$celkem,$poradi_od,$poradi_do,$prijat,$bonifikace,$ucast,$id_ucebna,$poznamka,$odvolani,$zast_jmeno,$zast_prijmeni,$zast_pohlavi,$prevzal,$cj0,$aj,$pz,$oz,$termin,$aid,$listek,$zs_nazev,$prefix)=@_;
#		print Dumper(@_);
